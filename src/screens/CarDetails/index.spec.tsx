...
import { createMockNavigation, createMockCarRouteParams, renderWithTheme } from "../../utils/test-utils";
...
describe('CarDetails', () => {
    ...
    it('should render with custom car data', async () => {
        ...
        (useRoute as jest.Mock).mockReturnValue(createMockCarRouteParams(customCarData));
