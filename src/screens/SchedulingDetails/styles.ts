...
export const Brand = styled.Text`
    font-family: ${({ theme }: { theme: DefaultTheme }) => theme.fonts.secondary_500};
...
export const RentalPeriod = styled.View`
    ...
    border-bottom-color: ${({ theme }: { theme: DefaultTheme }) => theme.colors.line};
    padding-bottom: 16px;
`;
...
export const CalendarIcon = styled.View`
    width: 48px;
    height: 48px;
    background-color: ${({ theme }: { theme: DefaultTheme }) => theme.colors.main};
